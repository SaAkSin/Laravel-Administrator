					...
					<template x-if="field.editable">
						<div class="upload_container" :id="field.field_id">
							...
							<button type="button" @click="$event.target.parentElement.querySelector('input[type=file]').click()"
									:disabled="freezeForm" style="padding: 4px 10px; font-size: 11px; display: inline-flex; align-items: center; justify-content: center; gap: 4px; line-height: 1 !important;">
								...
								<span style="display: inline-block; line-height: 1; vertical-align: middle;"><?php echo trans('administrator::administrator.uploadimage') ?></span>
							</button>
