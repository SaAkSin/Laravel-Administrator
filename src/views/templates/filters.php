						...
						<div class="combobox-container" 
							...
							<div class="combobox-value-row" 
								...
								<span class="selected-text" 
									  x-text="filter.type !== 'belongs_to_many' && selectedItems[0] ? selectedItems[0].text : '-- 전체 --'" 
									  :style="{
										  fontSize: '12px',
										  color: (filter.type !== 'belongs_to_many' && selectedItems[0]) ? '#1f2937' : '#9ca3af',
										  whiteSpace: 'nowrap',
										  overflow: 'hidden',
								...
								<div class="value-actions" style="display: flex; align-items: center; gap: 6px; margin-left: auto;">
									...
									<span class="clear-btn" 
										  x-show="filter.type !== 'belongs_to_many' && selectedItems[0] && selectedItems[0].id !== '' && selectedItems[0].id !== null && selectedItems[0].id !== undefined" 
