					...
					<div class="relation-combobox-wrapper" :class="{ 'open': open }" @click.away="open = false" style="position: relative; width: 100%;">
						...
						<div class="combobox-container" 
							...
							<div class="combobox-value-row" 
								...
								<span class="selected-text" 
									  x-text="(filter.type !== 'belongs_to_many' && selectedItems.length > 0 && selectedItems[0].id !== '' && selectedItems[0].id != null) ? selectedItems[0].text : '-- Select Some Options --'" 
									  :style="{
										  fontSize: '12px',
										  color: (filter.type !== 'belongs_to_many' && selectedItems.length > 0 && selectedItems[0].id !== '' && selectedItems[0].id != null) ? '#1f2937' : '#9ca3af',
										  whiteSpace: 'nowrap',
										  overflow: 'hidden',
										  textOverflow: 'ellipsis',
										  maxWidth: '170px'
								...
								<div class="value-actions" style="display: flex; align-items: center; gap: 6px; margin-left: auto;">
									...
									<span class="clear-btn" 
										  x-show="filter.type !== 'belongs_to_many' && selectedItems.length > 0 && selectedItems[0].id !== '' && selectedItems[0].id != null" 
										  @click.stop="clearSelection()"
										  style="color: #9ca3af; font-size: 16px; font-weight: bold; cursor: pointer; line-height: 1; transition: color 0.1s ease; outline: none; display: inline-block;">×</span>
