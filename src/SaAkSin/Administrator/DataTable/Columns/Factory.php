<?php
namespace SaAkSin\Administrator\DataTable\Columns;
...
use SaAkSin\Administrator\DataTable\Columns\Relationships\BelongsToMany;
use SaAkSin\Administrator\DataTable\Columns\Relationships\HasOneOrMany;
...
class Factory {
	 ...
	 * @param array		$options
	 *
	 * @return \SaAkSin\Administrator\DataTable\Columns\Column
	 */
	...
	public function getIncludedColumns(array $fields)
	{
		...
		if (!sizeof($this->includedColumns))
		{
			...
			{
				if (is_a($field, 'SaAkSin\\Administrator\\Fields\\Relationships\\BelongsTo'))
				{
