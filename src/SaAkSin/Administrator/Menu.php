...
class Menu {
	 ...
	 * The config instance
	 *
	 * @var \SaAkSin\Administrator\Config\Factory
	 */
	 ...
	 * @param \SaAkSin\Administrator\Config\Factory	$config
	 */
	...
	public function getMenu($subMenu = null)
	{
		...
		foreach ($subMenu as $key => $item)
		{
			...
			if (is_string($item))
			{
				...
				if (is_a($config, 'SaAkSin\Administrator\Config\Config') && $config->getOption('permission'))
				{
