<?php
namespace SaAkSin\Administrator\Config\Model;

use SaAkSin\Administrator\Config\Config as ConfigBase;
use SaAkSin\Administrator\Config\ConfigInterface;
use SaAkSin\Administrator\Fields\Factory as FieldFactory;
use SaAkSin\Administrator\Fields\Field as Field;
...
class Config extends ConfigBase implements ConfigInterface {
	 ...
	 * @return \Illuminate\Database\Eloquent\Model
	 */
	public function getModel($id, array $fields, array $columns)
	{
	 ...
	 * @param \SaAkSin\Administrator\Actions\Factory	$actionFactory
	 *
	 * @return \Illuminate\Database\Eloquent\Model
	 */
