...
- `main` 브랜치를 기준으로 포크(fork)하고, PR 역시 `main` 브랜치로 제출해 주십시오.

- 풀 리퀘스트를 제출하기 전에 `main` 브랜치의 최신 변경 사항을 병합(merge)해 주십시오. 충돌 등으로 인해 자동으로 병합할 수 없는 경우, 최신 변경 사항을 병합한 뒤 다시 제출하도록 요청받을 수 있습니다.

- 추가하거나 변경한 사항에 대한 문서를 `/docs` 디렉토리 내 관련 섹션에 작성해 주십시오.

- 변경 사항을 검증할 수 있는 단위 테스트(unit test)를 필요한 만큼 추가해 주십시오.

- [스타일 가이드](./style-guide.md)를 준수해 주십시오!

<a name="style-guide"></a>
## 스타일 가이드

스타일 가이드에 대한 자세한 내용은 [스타일 가이드](./style-guide.md) 페이지를 참고해 주시기 바랍니다.
