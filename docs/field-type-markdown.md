...
Since the `markdown` field type requires a bit of space, you may want to think about [expanding your model's form width](./model-configuration.md#form-width) to something like `400`.