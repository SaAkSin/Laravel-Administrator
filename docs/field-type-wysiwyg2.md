...
> [!NOTE]
> The `wysiwyg2` type uses the lightweight **Quill** editor. If you prefer the classic, full-featured editor with advanced options like tables and raw source code editing, you can use the [WYSIWYG](./field-type-wysiwyg.md) (`type => 'wysiwyg'`) field type which uses **CKEditor 4**.
